...
import type { PluginItem } from "@onmyagent/types/server";
import { readJsoncFile, updateJsoncTopLevel } from "../core/jsonc.js";
import { opencodeConfigPath, projectPluginsDir } from "../workspace/workspace-files.js";
import { exists } from "../core/utils.js";
import { validatePluginSpec } from "../core/validators.js";
