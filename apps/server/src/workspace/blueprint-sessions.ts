...
export function normalizeBlueprintSessionTemplates(onmyagent: Record<string, unknown> | null | undefined): BlueprintSessionTemplate[] {
  const blueprint = readRecord(onmyagent?.blueprint);
...
export function readMaterializedBlueprintSessions(onmyagent: Record<string, unknown> | null | undefined): MaterializedBlueprintSession[] {
  const blueprint = readRecord(onmyagent?.blueprint);
...
export function applyMaterializedBlueprintSessions(
  onmyagent: Record<string, unknown> | null | undefined,
