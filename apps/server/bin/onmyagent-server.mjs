...
const binaryName = process.platform === "win32" ? "onmyagent-server.exe" : "onmyagent-server";
...
console.error(
  `Unable to find an OnMyAgent server entrypoint in ${basename(packageRoot)}. Build the package or run it from a source checkout with Bun available.`,
);
process.exit(1);
