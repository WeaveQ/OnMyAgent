...
| **PPT / 幻灯片精细编辑（增删页 / 形状 / 文本 / 表格 / 图表 / 批注 / 动画 / 主题 / 备注等任何对已有 PPT 的修改）** | **slide**   | **`references/slideengine_references.md`（slide*\* 系列工具，必须通过独立的 slide-mcp 服务调用；禁止用 doc*\* 或 tencent-docs 通用工具改 PPT）** |
