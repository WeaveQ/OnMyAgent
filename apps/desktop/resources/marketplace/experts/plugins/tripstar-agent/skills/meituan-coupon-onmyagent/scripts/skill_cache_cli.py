...
【公域数据】（跨 Skill 共享）
  # 认证 Token 管理
  skill-cache auth set meituan-coupon-onmyagent --data '{"user_token":"xxx","device_token":"yyy"}'
  skill-cache auth get meituan-coupon-onmyagent
  skill-cache auth get meituan-coupon-onmyagent --key user_token
  skill-cache auth list
  skill-cache auth delete meituan-coupon-onmyagent
