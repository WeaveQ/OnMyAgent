...
display_name: 小红书涨粉数据
display_name_en: RedNote Follower Rankings
description_zh: 人工校验的小红书账号涨粉日榜、周榜、月榜数据查询，覆盖 25 个品类，支持生成排名图片与 Excel 导出
description_en: Track daily, weekly and monthly follower growth rankings for Xiaohongshu accounts, manually verified across 25 categories.
