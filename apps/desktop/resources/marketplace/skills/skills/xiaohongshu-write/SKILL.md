...
display_name_en: Xiaohongshu Note Writer
description_zh: 基于爆款笔记数据，AI 提炼流量密码，生成可直接发布的小红书文案
description_en: Generate ready-to-publish Xiaohongshu notes based on trending note data analysis
category: writing
version: 1.0.0
author: 红狐数据
---
...
**Q: 如何配置 API Key？**
A: 请前往 [红狐hub](https://redfox.hk/settings/api-keys?source=workbuddy) 获取 API KEY，通过环境变量 `REDFOX_API_KEY` 配置。
