...
display_name: 小红书账号榜单
display_name_en: XHS Top Accounts
description: 小红书账号榜单追踪分析工具，支持查询日榜周榜月榜TOP50排名和热门账号
description_zh: 小红书账号榜单追踪工具，支持日榜周榜月榜TOP50查询，按品类筛选并生成HTML可视化报告。
description_en: XHS account ranking tracker. Supports daily/weekly/monthly TOP50 rankings, category filtering, and HTML report generation.
category: data
version: 1.0.1
author: 红狐数据
---
