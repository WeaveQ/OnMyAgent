---
name: douyin-search
description: 抖音作品查询工具。根据关键词搜索抖音热门爆款作品，支持按日期范围筛选，结果以结构化表格展示。当用户查找抖音热门内容、搜索抖音爆款视频、查询抖音作品数据时使用。触发词：抖音作品查询、抖音爆款、抖音热门、抖音热榜、抖音搜索、爆款视频、热门视频。
display_name: 抖音作品查询
display_name_en: Douyin Video Search
description_zh: 根据关键词搜索抖音热门爆款作品，支持日期筛选，结构化展示互动数据
description_en: Search trending Douyin videos by keywords with date filtering and engagement metrics
category: search
version: 1.0.0
author: 红狐数据
---
...
- 获取 API Key：前往 [红狐hub](https://redfox.hk/settings/api-keys?source=workbuddy)
...
每条作品字段：`title`、`author`、`like_count`、`comment_count`、`share_count`、`collect_count`、`work_url`、`publish_time`
...
**⚠️ A1~A3 同一轮输出连续完成，A3 后紧跟 Step 5。**
