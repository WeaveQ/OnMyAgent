/**
 * Release-channel concept for OnMyAgent desktop builds.
 *
...
/** Stable channel's Electron updater manifest URL. */
export const STABLE_UPDATER_ENDPOINT =
  "https://github.com/WeaveQ/onmyagent/releases/latest/download/latest.json";

/** Alpha channel's Electron updater manifest URL (macOS-only, rolling). */
export const ALPHA_UPDATER_ENDPOINT =
  "https://github.com/WeaveQ/onmyagent/releases/download/alpha-macos-latest/latest.json";
...
/**
 * Resolve the Electron updater manifest URL for the requested channel.
 *
