...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none titlebar-no-drag focus-visible:ring-1 focus-visible:ring-dls-focus focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-dls-status-danger-border aria-invalid:ring-3 aria-invalid:ring-dls-danger/20 dark:aria-invalid:border-dls-status-danger-border dark:aria-invalid:ring-dls-danger/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 relative",
  {
    variants: {
      variant: {
        default:
          "bg-dls-decision text-white hover:bg-dls-decision-hover bg-clip-padding before:pointer-events-none before:absolute before:inset-0 before:rounded-lg active:not-aria-[haspopup]:translate-y-px",
        outline:
        ...
        ghost: "hover:text-dls-text aria-expanded:text-dls-text",
        destructive:
