...
export function CommandInput({
  ...
  return (
    <AutocompleteInput
      autoFocus
      className={cn(
        "border-transparent! bg-transparent! before:hidden focus-visible:ring-0! has-focus-visible:ring-0!",
        className,
      )}
