...
SKILL_NAME="meituan-coupon-onmyagent"
SKILL_DIR=""
...
路径：`~/.xiaomei-workspace/skills_local_cache/meituan-coupon-onmyagent/data/mt_ods_coupon_history.json`
...
路径：`~/.xiaomei-workspace/skills_local_cache/meituan-coupon-onmyagent/data/mt_ods_coupon_phone_history.json`
