...
| 文档 | 主题 | 优先级 |
|------|------|--------|
| [多智能体委派话术](./onmyagent-agent-briefings.md) | S3 / S5 委派模板 | **P1** |
...
| [OnMyAgent 宿主集成](../06-plugin/onmyagent-host-integration.md) | 最小脚本契约与调用顺序 | **P0** |
| [Tier1 市场 FAQ](../06-plugin/tier1-marketplace-faq.md) | 清单与源码树、minimax-xlsx 说明 | **P1** |
| [OnMyAgent 集成检查清单](../../releases/onmyagent-integration-checklist.md) | 发布 / 审核前核对 | **P1** |
...
- **"书稿索引 / 历史书稿检索"** → `intake-router --search`（登记见 `~/.onmyagent/fbs-book-projects.json`）；片段索引见 `fbs-runtime-hints.bookIndex`
...
- **"首屏菜单过长 / 退出没收尾 / 意图外提问"** → [`intake-and-routing.md`](./intake-and-routing.md)「OnMyAgent 实测复盘」· [`ux-agent-playbook.md`](../05-ops/ux-agent-playbook.md) §4.1–4.3
