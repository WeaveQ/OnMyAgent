...
> **适用宿主**：OnMyAgent（内置 lexical-markdown-editor 扩展）

## 概述

OnMyAgent内置基于Lexical框架的Markdown编辑器扩展，包含898个JS文件，提供所见即所得编辑能力。FBS-BookWriter可利用此编辑器增强书稿编辑体验。
...
- OnMyAgent内置扩展路径：`D:\OnMyAgent\resources\app\extensions\lexical-markdown-editor\`
