# OnMyAgent Writing-First OS 实施单（v2.1.2）
...
- 所有命令退出码为 `0`
- `pack:release` 产出 `dist/fbs-bookwriter-v212-onmyagent.zip`
...
- 实施单：`releases/onmyagent-writing-first-os-implementation-v2.1.2.md`
- 验收记录（执行后补充）：`releases/onmyagent-writing-first-os-acceptance-v2.1.2.md`
- 发布包：`dist/fbs-bookwriter-v212-onmyagent.zip`
