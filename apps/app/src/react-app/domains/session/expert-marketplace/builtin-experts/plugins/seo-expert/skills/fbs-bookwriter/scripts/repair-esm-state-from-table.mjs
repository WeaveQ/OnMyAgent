#!/usr/bin/env node
/**
 * 修复 .fbs/esm-state.md 中 frontmatter currentState 与正文表格「当前状态」不一致的问题（OnMyAgent 实测 P0-01）。
...
import { parseFrontmatterCurrentState } from "./onmyagent-session-snapshot.mjs";
