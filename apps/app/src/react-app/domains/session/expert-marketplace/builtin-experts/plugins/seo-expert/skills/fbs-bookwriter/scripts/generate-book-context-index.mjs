...
const SECTIONS = [
  ...
  },
  {
    ...
    files: [
      ...
      "references/05-ops/onmyagent-skill-foundation.md",
      "references/05-ops/heartbeat-protocol.md",
      "references/05-ops/codebuddy-memory-onmyagent-integration.md",
    ],
  },
];
...
function main() {
  ...
  lines.push("## 说明");
  lines.push("");
  lines.push("- 宿主 `@` 深度与递归限制以 CodeBuddy / OnMyAgent 当前版本为准。");
