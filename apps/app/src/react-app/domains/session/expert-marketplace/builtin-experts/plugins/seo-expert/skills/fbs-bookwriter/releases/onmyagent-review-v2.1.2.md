# OnMyAgent 官方审核包说明（v2.1.2）

- **版本**：`2.1.2`
- **状态**：入口状态机固化·意图单真源·IntentOps 门禁增强版
- **审核包**：`dist/fbs-bookwriter-v212-onmyagent.zip`
- **校验报告**：`dist/fbs-bookwriter-v212-onmyagent.verification.json`
- **通道清单**：`onmyagent/channel-manifest.json`
...
1. `onmyagent/channel-manifest.json`（version: 2.1.2）
...
以 `dist/fbs-bookwriter-v212-onmyagent.verification.json` 为最终校验真值。

## 提交建议

提交 OnMyAgent 官方审核时，优先附上：

1. `dist/fbs-bookwriter-v212-onmyagent.zip`
2. `dist/fbs-bookwriter-v212-onmyagent.verification.json`
3. `onmyagent/channel-manifest.json`
4. 本说明文件 `releases/onmyagent-review-v2.1.2.md`
