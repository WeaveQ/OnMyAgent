...
<style>
*,*::before,*::after{box-sizing:border-box}:root{--color-background-primary:#fff;--color-background-secondary:#f4f4f5;--color-text-primary:#0f172a;--color-text-secondary:#64748b;--color-border-tertiary:#e5e7eb}.dark{--color-background-primary:#1f1f1f;--color-background-secondary:#2c2c2c;--color-text-primary:#f8fafc;--color-text-secondary:#94a3b8;--color-border-tertiary:#3a3a3a}html,body{width:100%;margin:0;overflow:visible;background:var(--color-background-primary)}body{font-family:system-ui,-apple-system,sans-serif;color:var(--color-text-primary);line-height:1.5}#root{width:100%;min-height:20px;overflow:visible;background:var(--color-background-primary)}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}
</style>
</head>
<body>
