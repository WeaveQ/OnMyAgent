...
export const messageTextClass = {
  body: "font-sans text-base leading-6 antialiased",
  bodyMuted: "font-sans text-base leading-6 text-dls-secondary antialiased",
  toolStatus: "ml-7 mt-2 text-base leading-6 text-dls-secondary",
  toolLabel: "mb-1 text-sm font-medium text-dls-secondary",
  assistantBubble: "w-full relative text-dls-text group",
  nestedAssistantBubble: "w-full relative text-base leading-6 text-dls-text group",
  avatarLabel: "max-w-[120px] truncate text-base font-medium leading-tight text-dls-text",
  baseMessageBubble: "text-base text-dls-text leading-relaxed",
...
export const messageStateClass = {
  skillReferenceChip: "inline-flex items-center gap-1 rounded-md border border-dls-accent/30 bg-dls-accent/10 px-2 py-0.5 font-mono text-sm font-medium text-dls-accent",
  toolError: "overflow-x-auto rounded-xl border border-dls-status-danger-border bg-dls-status-danger-soft px-4 py-3 text-sm leading-6 text-dls-status-danger",
