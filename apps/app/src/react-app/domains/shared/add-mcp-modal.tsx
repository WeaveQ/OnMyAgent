        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5">
              <SegmentedTabButton
                type="button"
                active={state.serverType === "remote"}
                size="compact"
                width="hug"
              ...
              <SegmentedTabButton
                ...
                active={state.serverType === "local"}
                size="compact"
                width="hug"
                className={props.isRemoteWorkspace ? "cursor-not-allowed opacity-50" : ""}
                onClick={() => {
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-xl border border-dls-border bg-dls-hover/40 p-3">
                ...
                <div className="flex items-start gap-2 text-xs text-dls-secondary">
                  <Checkbox
                    id={oauthRequiredId}
                    className="mt-0.5 border-dls-border"
                    checked={state.oauthRequired}
                    onCheckedChange={(checked) => dispatch({ oauthRequired: checked === true })}
                    nativeButton
          ...
          {state.error ? <NoticeBox tone="error">{state.error}</NoticeBox> : null}
        </div>
