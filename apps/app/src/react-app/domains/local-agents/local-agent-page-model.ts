...
export function agentFromAcpMetadata(metadata: PersonalLocalAgentMetadata): PersonalLocalAgent {
  ...
  return {
    ...
    acpArgs: Array.isArray(metadata.acpArgs) ? metadata.acpArgs : [],
    connectionType: metadata.connectionType === "cli" ? "cli" : undefined,
    supportsAcp: metadata.capability?.supportsAcp ?? undefined,
    modelOptions,
