...
const environmentLayoutClass = {
  panelHeader: "flex items-start justify-between gap-4",
  description: "max-w-[52ch]",
  applyDescription: "max-w-[54ch]",
  editorDialog: "w-full max-w-md sm:max-w-md",
  monoField: "font-mono",
};
...
function EnvironmentSettingsPanel(props: EnvironmentSettingsPanelProps) {
  ...
  return (
    <LayoutSection>
      ...
      {!props.isRemoteWorkspace ? (
        <LayoutSectionItemFootnote className="whitespace-nowrap">
  ...
  return (
    <>
      <Alert variant="warning">
        ...
        <AlertDescription className={environmentLayoutClass.applyDescription}>
...
function EnvironmentEditorModal(props: EnvironmentEditorModalProps) {
  ...
  return (
    ...
    >
      <DialogContent className={environmentLayoutClass.editorDialog}>
        <DialogHeader>
        ...
        <FieldGroup>
          ...
          <Field data-invalid={error ? true : undefined}>
            ...
            <Textarea
              ...
              spellCheck={false}
              autoComplete="off"
              className={environmentLayoutClass.monoField}
              aria-invalid={error ? true : undefined}
            />
