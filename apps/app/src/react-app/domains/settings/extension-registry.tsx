...
export type ExtensionRuntimeContext = Pick<
  ...
  "onmyagentServerClient" | "extensionConnections" | "onExtensionConnectionChange"
>;

export type OnMyAgentExtensionRuntime = {
  id: string;
...
const runtimeRegistry = new Map<string, OnMyAgentExtensionRuntime>();

export function registerExtensionConfig(id: string, factory: ExtensionConfigFactory) {
  registry.set(id, factory);
}

export function registerExtensionRuntime(runtime: OnMyAgentExtensionRuntime) {
