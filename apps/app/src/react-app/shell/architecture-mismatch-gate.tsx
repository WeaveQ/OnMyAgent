...
const architectureGateClass = {
  ...
  panel: "w-full overflow-hidden rounded-3xl border border-dls-surface/10 bg-dls-surface/5",
  grid: "grid gap-0 lg:grid-cols-[1.05fr_0.95fr]",
  content: "space-y-8 p-8 sm:p-10 lg:p-12",
  intro: "space-y-4",
  compareGrid: "grid gap-3 sm:grid-cols-2",
  appCard: "rounded-2xl border border-dls-surface/10 bg-black/20 p-4",
  actions: "flex flex-col gap-3 sm:flex-row",
  eyebrow: "text-xs font-medium text-dls-status-warning",
  eyebrowBadge: "inline-flex rounded-full border border-dls-status-warning/25 bg-dls-status-warning/12 px-3 py-1",
  ...
  systemCard: "rounded-2xl border border-dls-status-success-border bg-dls-status-success-soft p-4",
  ...
  downloadButton: "rounded-full bg-white text-black hover:bg-dls-status-success-soft",
  releaseButton: "rounded-full border-dls-surface/14 bg-transparent text-white/85 hover:bg-white/10 hover:text-white",
  ...
  asideBody: "space-y-5 rounded-2xl border border-dls-surface/10 bg-black/25 p-6 text-sm leading-6 text-white/68",
  asideTitle: "text-base font-medium text-white",
  asideCode: "rounded-2xl bg-dls-surface/10 p-4 font-mono text-xs text-white/55",
};
