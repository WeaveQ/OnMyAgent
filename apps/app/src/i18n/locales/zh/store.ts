...
export default {
  ...
  "store.find_skill_placeholder": "搜索技能名称或描述…",
  "store.find_skill_empty": "没有匹配的技能",
  "store.find_skill_hint": "从技能市场中搜索并安装",
  ...
  "skills_marketplace.category_developer": "开发部署",
  "skills_marketplace.category_deploy": "开发部署",
  ...
  "skills_marketplace.view_detail_short": "查看详情",
