...
export default {
  ...
  "system.load_session_route": "正在加載工作區…",
  "system.load_settings_route": "正在加載設置…",
  "system.load_welcome_route": "正在準備入門引導…",
  "system.load_settings_chunk": "正在打開設置…",
  "system.load_welcome_chunk": "正在打開入門引導…",
  "system.load_settings_tab": "正在加載頁面…",
  "system.load_settings_ai": "正在加載服務商…",
  "system.load_session_refresh": "正在刷新工作區…",
