...
export default {
  ...
  "files.uploads_empty_hint":
    "從本機匯入檔案。OnMyAgent 會複製到工作區，供對話安全引用。智能體產生的檔案請到「任務」查看。",
  ...
  "files.open_source_session": "打開來源會話",
  "files.open_source_session_archived": "打開已歸檔會話",
  "files.open_source_session_missing": "原會話已刪除，無法打開",
  "files.create_folder": "新建資料夾",
  "files.create_folder_title": "新建資料夾",
  "files.create_folder_placeholder": "資料夾名稱",
  "files.create_folder_confirm": "建立",
  "files.create_folder_success": "已建立資料夾「{name}」",
  "files.create_folder_failed": "無法建立資料夾",
  "files.create_folder_invalid": "請輸入有效的資料夾名稱",
  "files.move_here": "移動到此處",
  "files.move_success": "已移動「{name}」",
  "files.move_to": "移動到",
  "files.move_to_title": "移動到",
  "files.move_to_hint": "選擇工作區「我的檔案」下的目標資料夾",
  "files.move_to_root": "我的檔案",
  "files.move_to_search": "搜尋資料夾名",
  "files.move_to_confirm": "確認",
  "files.move_to_empty": "暫無子資料夾，可新建或選擇上方目前目錄",
  "files.move_to_current": "目前目錄",
  "files.move_to_open": "打開",
  "files.move_to_success": "已移動到「{folder}」",
  "files.move_view": "查看",
  "files.move_failed": "無法移動檔案",
  "files.move_invalid": "不能移動到該位置",
  ...
  "files.collapse_tree": "收起檔案列表",
  "files.expand_tree": "展開檔案列表",
  "files.collapse_all_folders": "收起全部",
  "files.expand_all_folders": "展開全部",
  "files.resize_tree": "調整檔案列表寬度",
  "files.copied": "已複製",
  ...
  "files.catalog_truncated":
    "僅顯示前 {limit} 項。請用搜尋篩選，或進入子資料夾查看更多。",
  "files.workspace": "工作區",
