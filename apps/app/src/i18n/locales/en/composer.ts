...
export default {
  ...
  "composer.file_exceeds_limit": "{name} exceeds the {max} limit.",
  "composer.file_exceeds_limit_title": "File too large to attach",
  "composer.file_exceeds_limit_detail": "{name} (limit {max})",
  "composer.file_exceeds_limit_multi": "{count} files exceed the {max} limit",
  ...
  "composer.queued_count": "{count} queued messages",
  "composer.queued_delete": "Remove from queue",
  "composer.queued_edit": "Edit queued message",
  "composer.queued_empty": "No text",
  "composer.queued_files": "{count} files",
  "composer.queued_files_one": "{count} file",
  "composer.queued_promote": "Send next",
  ...
  "composer.access_default_desc": "Ask before files or internet",
