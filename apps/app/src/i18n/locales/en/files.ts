...
export default {
  ...
  "files.source_uploads_desc":
    "Files you imported into this workspace.",
  "files.source_task_desc":
    "Home temporary-task outputs and other non-expert workspace folders.",
  "files.source_expert_desc": "Expert agent folders and their task outputs.",
  ...
  "files.move_to_title": "Move to",
  "files.move_to_hint": "Choose a folder under My files in this workspace",
  "files.move_to_root": "My files",
  "files.move_to_search": "Search folders",
  "files.move_to_confirm": "Confirm",
  "files.move_to_empty": "No subfolders yet — create one or choose the current folder above",
  "files.move_to_current": "Current folder",
  "files.move_to_open": "Open",
  ...
  "files.collapse_tree": "Collapse file list",
  "files.expand_tree": "Expand file list",
  "files.collapse_all_folders": "Collapse all",
  "files.expand_all_folders": "Expand all",
  "files.resize_tree": "Resize file list",
  "files.copied": "Copied",
