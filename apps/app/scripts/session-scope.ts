...
const starterRoot = "/Users/test/OnMyAgent/starter";
const otherRoot = "/Users/test/OnMyAgent/second";
...
try {
  ...
  step("windows create and list use the same transport directory", () => {
    ...
    const winRoot = String.raw`C:\Users\Test\OnMyAgent\starter`;
    ...
    const verbatimDriveRoot = String.raw`\\?\C:\Users\Test\OnMyAgent\starter`;
    assert.equal(toSessionTransportDirectory(verbatimDriveRoot), String.raw`C:\Users\Test\OnMyAgent\starter`);
    assert.equal(describeDirectoryScope(verbatimDriveRoot).normalized, "c:/users/test/onmyagent/starter");
  });
  ...
  step("round-trip invariant: every query path equals the create path (windows)", () => {
    ...
    const windowsPaths = [
      "C:\\Users\\Test\\OnMyAgent\\starter",
      "C:\\Users\\Test\\OnMyAgent\\starter\\",
      "D:\\projects\\my-app",
