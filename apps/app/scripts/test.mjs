...
const testTargets = new Map([
  ...
  ['enhance-home-prompt-model', ['bun', ['test', 'scripts/enhance-home-prompt-model.test.ts']]],
  ['opencode-enhance-prompt', ['bun', ['test', 'scripts/opencode-enhance-prompt.test.ts']]],
  ...
  ['access-permission-select-contract', ['bun', ['test', 'scripts/access-permission-select-contract.test.ts']]],
  ['follow-up-suggestions', ['bun', ['test', 'scripts/follow-up-suggestions.test.ts']]],
...
const composedTargets = new Map([
  ...
  ['ui-contracts', [
    ...
    'access-permission-select-contract',
