...
const serverBin = resolve(root, "..", "server", "dist", "bin", "onmyagent-server");
...
await copyFile(serverBin, resolve(targetDir, "onmyagent-server"));
...
const versions = {
  "onmyagent-server": {
    ...
    sha256: await sha256(resolve(targetDir, "onmyagent-server")),
  },
