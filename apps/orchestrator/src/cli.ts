...
const DEFAULT_ONMYAGENT_PORT = 8787;
...
const SANDBOX_INTERNAL_ONMYAGENT_PORT = DEFAULT_ONMYAGENT_PORT;
...
const ONMYAGENT_DEV_DATA_DIR = "onmyagent-dev-data";
...
type SidecarName = "onmyagent-server" | "opencode-router" | "opencode";
...
type RuntimeServiceName = "onmyagent-server" | "opencode" | "opencode-router";
...
async function resolveLocalOpencodeBin(): Promise<string | undefined> {
...
async function resolveLocalOpencodeConfigDir(): Promise<string | undefined> {
...
async function resolveOpencodeStateLayout(options: {
  dataDir: string;
  workspace: string;
  devMode: boolean;
