...
const serviceCycle = ["all", "onmyagent-orchestrator", "opencode", "onmyagent-server", "router"];
          ...
          <Show when={state.view === "overview"}>
            <box flexDirection="row" gap={4} paddingTop={1}>
              ...
              <box width={Math.floor(dimensions().width / 2) - 4} flexDirection="column" gap={1}>
                ...
                <text fg={theme.textMuted}>OnMyAgent URL (LAN)</text>
                <text fg={theme.text}>{state.connect.onmyagentUrl}</text>
                <text fg={theme.textMuted}>OnMyAgent Collaborator Token</text>
                <text fg={theme.text}>{state.connect.onmyagentToken}</text>
                <Show when={state.connect.ownerToken}>
                  <text fg={theme.textMuted}>OnMyAgent Owner Token</text>
                  <text fg={theme.text}>{state.connect.ownerToken}</text>
                </Show>
                <text fg={theme.textMuted}>OnMyAgent Host Admin Token</text>
