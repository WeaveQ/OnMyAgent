...
| **Local knowledge base** | Multiple vaults, block editing, save from a session | **Knowledge** rail (`data/user/knowledge/`) plus the `knowledge_search` session tool | ✅ Available | Open **Knowledge** in the main rail; this is not Skills and not [Memory](/en/guide/memory) |
