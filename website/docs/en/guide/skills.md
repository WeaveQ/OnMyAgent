...
| **Local knowledge base** | Read and write Markdown notes | **Knowledge** rail (`data/user/knowledge/`) plus the `knowledge_search` session tool | ✅ Available | Open **Knowledge** in the main rail; this is not Skills and not [Memory](/en/guide/memory) |
