...
The 0.4 line delivered the Task Center, isolated expert runtime, local config profiles, and the packaged auto-update channel — the first desktop foundation.
