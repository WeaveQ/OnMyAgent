...
export const desktopPolicyDefinitions = [
  {
    ...
    description:
      "Allow users to add and use models that are not deployed through OnMyAgent Cloud.",
    userNotice:
  ...
  },
  {
    ...
    description:
      "Allow users to see and use OnMyAgent's built-in extensions, including browser, image, and local-provider extensions.",
    userNotice:
      "Your organization administrator has disabled built-in OnMyAgent extensions.",
    defaultValue: true,
  },
  {
    id: "showWelcomePage",
