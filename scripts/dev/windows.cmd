...
if not defined VSDEVCMD (
  echo [onmyagent] Could not find VsDevCmd.bat. Install Visual Studio Build Tools with Desktop development with C++.
  exit /b 1
)
...
if /I "%TARGET_ARCH%"=="x64" (
  call corepack pnpm --filter @onmyagent/desktop dev:windows:x64
) else (
  call corepack pnpm --filter @onmyagent/desktop dev:windows
)
