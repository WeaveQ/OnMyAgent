...
check("onmyagent-orchestrator", orchestratorVersion);
check("onmyagent-server", serverVersion);
...
console.log(`Release tag ${tag} matches app/desktop/onmyagent-orchestrator versions.`);
