...
const testTargets = new Map([
  ...
  ['local-agent-approval-overflow-smoke', { command: 'pnpm', args: ['--filter', '@onmyagent/app', 'test:app', 'local-agent-approval-overflow-smoke'] }],
  ['local-agent-workspace-picker-ui-smoke', { command: 'pnpm', args: ['--filter', '@onmyagent/app', 'test:app', 'local-agent-workspace-picker-ui-smoke'] }],
