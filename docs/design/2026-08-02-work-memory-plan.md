...
| 字段 | 内容 |
| ---- | ---- |
| 文档状态 | **路径与产品规则 SoT v1.5**（桌面 seed / 设置注入已落地；后续切片仍以本文为准） |
| 日期 | 2026-08-02 · 状态刷新 2026-08-05 |
| 产品名（用户可见） | 设置内 **个人** + **记忆** |
| 工程名 | Work Memory / `awareness` |
| 对标 | WorkBuddy（个性化 + 记忆）× 千问办公（意识文件包） |
| 对齐 OMA 设计 | 0726 设想对照 · 0802 双模式 · 0802 配置迁移 · 产品分层 · **[阶段二路线图](./2026-08-02-phase-2-enterprise-prep.md)** |
| 工程仓关联 | 路径/规则以本文为准；运行时实现以 monorepo 代码为准 |
| 代码入口 | `apps/desktop/electron/ensure-work-memory-awareness.mjs` · `data/user/awareness/` |
